  ...
  const animateStats = () => {
    ...
    const timer = setInterval(() => {
      ...
      setStats({
        ...
        lessons: Math.round(targetStats.lessons * progress),
        xpEarned: Math.round(targetStats.xpEarned * progress),
      });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              <button onClick={() => scrollToSection('features')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors">
                Features
              </button>
              <button onClick={() => scrollToSection('languages')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors">
                Languages
              </button>
              <button onClick={() => scrollToSection('testimonials')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors">
                Testimonials
              </button>
              <button onClick={() => scrollToSection('faq')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors">
                FAQ
              </button>
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-[#2A302E] animate-in slide-in-from-top duration-200">
              <div className="flex flex-col gap-3">
                <button onClick={() => scrollToSection('features')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors px-4 py-2 rounded-lg hover:bg-[#1E2322]">
                  Features
                </button>
                <button onClick={() => scrollToSection('languages')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors px-4 py-2 rounded-lg hover:bg-[#1E2322]">
                  Languages
                </button>
                <button onClick={() => scrollToSection('testimonials')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors px-4 py-2 rounded-lg hover:bg-[#1E2322]">
                  Testimonials
                </button>
                <button onClick={() => scrollToSection('faq')} className="text-sm text-[#9CA3A0] hover:text-[#EDEFEE] transition-colors px-4 py-2 rounded-lg hover:bg-[#1E2322]">
                  FAQ
                </button>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-6 bg-[#161A19] rounded-xl border border-[#2A302E]">
              <p className="text-3xl md:text-4xl font-bold text-[#10B981]">{stats.students.toLocaleString()}+</p>
              <p className="text-sm text-[#9CA3A0] mt-1">Students</p>
            </div>
            <div className="p-6 bg-[#161A19] rounded-xl border border-[#2A302E]">
              <p className="text-3xl md:text-4xl font-bold text-[#60A5FA]">{stats.courses}+</p>
              <p className="text-sm text-[#9CA3A0] mt-1">Courses</p>
            </div>
            <div className="p-6 bg-[#161A19] rounded-xl border border-[#2A302E]">
              <p className="text-3xl md:text-4xl font-bold text-[#FBBF24]">{stats.lessons.toLocaleString()}+</p>
              <p className="text-sm text-[#9CA3A0] mt-1">Lessons</p>
            </div>
            <div className="p-6 bg-[#161A19] rounded-xl border border-[#2A302E]">
              <p className="text-3xl md:text-4xl font-bold text-[#F87171]">{stats.xpEarned.toLocaleString()}+</p>
